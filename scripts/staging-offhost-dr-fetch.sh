...
if (
  ...
  !/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/u.test(marker.drillId) ||
...
\t' read -r LOSS_MARKER_DRILL_ID LOSS_DECLARED_AT LOSS_MARKER_CLOCK_SOURCE LOSS_MARKER_SHA <<<"$LOSS_MARKER_INFO"
