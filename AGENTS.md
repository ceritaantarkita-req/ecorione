...
- off-host Backup & DR: **ACTIVE / RUNTIME EXECUTION PENDING**; checkpoints 1–4 are CLOSED / PASS at repository boundaries, checkpoint 5 retention/timing evidence tooling is under repository review, and real independent copy plus total-host-loss recovery remain unproven;
