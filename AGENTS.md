...
- off-host Backup & DR: **ACTIVE / RUNTIME EXECUTION PENDING**; checkpoints 1–3 are CLOSED / PASS at repository boundaries, checkpoint 4 read-only source/target readiness guardrails are under repository review, and real independent copy plus total-host-loss recovery remain unproven;
