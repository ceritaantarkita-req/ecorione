...
- off-host Backup & DR: **ACTIVE / RUNTIME EXECUTION PENDING**; checkpoints 1–6 are CLOSED / PASS at repository boundaries, while real independent copy, real retained-generation/timing evidence, and total-host-loss recovery remain unproven;
