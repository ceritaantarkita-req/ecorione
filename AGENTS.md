...
- off-host Backup & DR: **ACTIVE / RUNTIME EXECUTION PENDING**; checkpoints 1–4 are CLOSED / PASS at repository boundaries, while real independent copy plus total-host-loss recovery remain unproven;
