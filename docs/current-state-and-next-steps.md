...
F6-E07 is **IMPLEMENTED / IN REVIEW**. `.inno-setup-version` pins Inno Setup `6.7.1`; Desktop Installer installs that exact Chocolatey version; a deterministic installer-toolchain review is wired into normal CI and release-security acceptance with focused tests. Closure now depends on exact-head CI/Product Eval plus a real Desktop Installer workflow run on this exact head.
...
F6-E07 verification source: `docs/verification/f6-e07-pinned-inno-setup-toolchain-2026-09-18.md`.
