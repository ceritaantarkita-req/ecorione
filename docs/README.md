...
- [offhost-dr-recovery.md](offhost-dr-recovery.md) — active off-host backup and total-host-loss recovery workstream; checkpoints 1–3 are closed, checkpoint 4 adds pre-mutation source/target readiness guardrails, and real runtime execution is pending.
...
- active operational scope — **Off-host Backup & DR / RUNTIME EXECUTION PENDING**; checkpoints 1–3 are CLOSED / PASS, checkpoint 4 readiness guardrails are under repository review, while real independent copy and total-host-loss application recovery remain pending runtime evidence.
