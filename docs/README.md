...
- [offhost-dr-recovery.md](offhost-dr-recovery.md) — active off-host backup and total-host-loss recovery workstream; checkpoints 1–2 are closed at repository boundaries and checkpoint 3 standalone replacement-host recovery is active.
...
- active operational scope — **Off-host Backup & DR / CHECKPOINT 3 STANDALONE REPLACEMENT-HOST RECOVERY**; checkpoints 1–2 are CLOSED / PASS at repository boundaries, while real independent copy and total-host-loss application recovery remain pending runtime evidence.
