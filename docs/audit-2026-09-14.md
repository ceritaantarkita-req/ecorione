...
> **HISTORICAL EVAL-PROVENANCE SNAPSHOT:** retained at this path because governed eval manifests cite specific findings in this file. Do not use it as current repository status. Current state lives in `docs/current-state-and-next-steps.md`.
