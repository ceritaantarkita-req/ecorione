...
Repository/documentation reconciliation closed through PR #354 / merge `265a28d4c53cc482af8ea33a6362a21e640d30e5`; governed Staging Deploy #1298 passed on that exact SHA with healthy 15-service staging evidence. Later docs-only bookkeeping may advance the exact SHA without changing the production-promotion decision. Public production remains deferred; staging evidence is not a promotion decision.
