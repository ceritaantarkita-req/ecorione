...
Current staging bookkeeping after A-11 is exact GitHub `main` `65bf8d2ce0b832bd12b0b279ccf9df0384a07c47` through Staging Deploy #1288. That does not promote staging to production and does not turn the single operator Basic-Auth gate into multi-user identity/RBAC.
