...
| PE-05 | Event/Webhook automation under existing policy | **ACTIVE** |
...
PE-04 is CLOSED / PASS. PE-05 is currently active; PE-06 remains blocked until PE-05 is CLOSED / PASS on the exact reviewed and merged head.
