...
Latest staging operational safe stop: [staging-capacity-recovery-safe-checkpoint-2026-09-24.md](staging-capacity-recovery-safe-checkpoint-2026-09-24.md). It preserves the later Docker-filesystem exhaustion incident, the still-fail-closed private edge, the unresolved exact host Git/disk state, merged repository guards through PR #297/#298, disabled staging CD, and the exact controlled host-recovery resume sequence.
