...
3. F6-E03: run release-security-acceptance continuously in normal CI
4. keep W18/W20 closed; production activation remains separately deferred
5. branch-protection repository settings remain a separate external governance gap
```
