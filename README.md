...
2. F6-E02 implementation complete: normal CI executes dependency:review
3. release acceptance protects package-script + CI gate presence
4. next = exact-head CI/Product Eval -> guarded merge -> closure
5. keep W18/W20 closed; production activation remains separately deferred
```
